...
public class SCRUMSprintAddStepDefinition {
	...
	public void I_open_the_sprint_tool_add_page() throws Throwable {
	...
	@Then("^I should get result \"([^\"]*)\" in sprints list$")
	public void I_should_get_result_in_stories_list(String expectedResult)
			throws Throwable {
		WebElement calculatorTextBox = driver.findElement(By.id("sprint-title"));
