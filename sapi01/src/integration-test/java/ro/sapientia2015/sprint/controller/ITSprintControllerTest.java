package ro.sapientia2015.sprint.controller;
...
public class ITSprintControllerTest {
    ...
    public void showAddForm() throws Exception {
        mockMvc.perform(get("/sprint/add"))
                ...
                .andExpect(view().name(SprintController.SPRINT_ADD))
    ...
    public void addEmpty() throws Exception {
        mockMvc.perform(post("/sprint/add")
                ...
                .sessionAttr(SprintController.MODEL_ATTRIBUTE, new StoryDTO())
        )
                .andExpect(status().isOk())
                .andExpect(view().name(SprintController.SPRINT_ADD))
                .andExpect(forwardedUrl("/WEB-INF/jsp/sprint/add.jsp"))
    ...
    public void add() throws Exception {
        String expectedRedirectViewPath = StoryTestUtil.createRedirectViewPath(SprintController.REQUEST_MAPPING_VIEW);
        ...
        mockMvc.perform(post("/story/add")
                ...
                .andExpect(model().attribute(SprintController.PARAMETER_ID, is("3")))
                .andExpect(flash().attribute(SprintController.FLASH_MESSAGE_KEY_FEEDBACK, is("Story entry: title was added.")));
    }
    ...
    public void findAll() throws Exception {
        mockMvc.perform(get("/sprint/list"))
                .andExpect(status().isOk())
                .andExpect(view().name(SprintController.SPRINT_LIST))
                //.andExpect(forwardedUrl("/WEB-INF/jsp/sprint/list.jsp"))
                .andExpect(model().attribute(SprintController.MODEL_ATTRIBUTE_LIST, hasSize(2)))
                ...
                .andExpect(model().attribute(SprintController.MODEL_ATTRIBUTE_LIST, hasItem(
                        allOf(
                                ...
                                hasProperty("description", is("Sprint 2 description")),
                                hasProperty("title", is("gyertya"))
                        )
                )));
    }
    ...
    public void findById() throws Exception {
        mockMvc.perform(get("/sprint/{id}", 1L))
                .andExpect(status().isOk())
                .andExpect(view().name(SprintController.SPRINT_VIEW))
                ...
                .andExpect(model().attribute(SprintController.MODEL_ATTRIBUTE, hasProperty("title", is("Bar"))));
    }
    ...
    public void deleteById() throws Exception {
        ...
        mockMvc.perform(get("/sprint/delete/{id}", 1L))
                .andExpect(status().isOk())
                .andExpect(view().name(expectedRedirectViewPath))
                .andExpect(flash().attribute(SprintController.FLASH_MESSAGE_KEY_FEEDBACK, is("Sprint entry: Bar was deleted.")));
    }
    ...
    public void showUpdateForm() throws Exception {
        mockMvc.perform(get("/sprint/update/{id}", 1L))
                .andExpect(status().isOk())
                .andExpect(view().name(SprintController.SPRINT_UPDATE))
    ...
    public void updateEmpty() throws Exception {
        mockMvc.perform(post("/sprint/update")
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                ...
                .andExpect(status().isOk())
                .andExpect(view().name(SprintController.SPRINT_UPDATE))
                //.andExpect(forwardedUrl("/WEB-INF/jsp/sprint/update.jsp"))
                .andExpect(model().attributeHasFieldErrors(SprintController.MODEL_ATTRIBUTE, "title"))
                .andExpect(model().attribute(SprintController.MODEL_ATTRIBUTE, hasProperty("id", is(1L))))
                .andExpect(model().attribute(SprintController.MODEL_ATTRIBUTE, hasProperty("description", isEmptyOrNullString())))
                .andExpect(model().attribute(SprintController.MODEL_ATTRIBUTE, hasProperty("title", isEmptyOrNullString())));
    ...
    public void update() throws Exception {
        ...
        mockMvc.perform(post("/story/update")
                ...
                .andExpect(status().isOk())
                .andExpect(view().name(expectedRedirectViewPath))
                .andExpect(model().attribute(SprintController.PARAMETER_ID, is("1")))
                .andExpect(flash().attribute(SprintController.FLASH_MESSAGE_KEY_FEEDBACK, is("Story entry: title was updated.")));
    }
